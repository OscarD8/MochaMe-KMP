package com.mochame.resonance.domain
...
// This is terrible and needs thought
val Mood.targetResonance: Resonance // Added the return type here
    get() = when (this) {
        Mood.FOCUS, Mood.ENERGIZED -> Resonance.LOGIC
        Mood.WONDER, Mood.CALM -> Resonance.WONDER
        Mood.BORED -> Resonance.WONDER
        Mood.SAD, Mood.TIRED -> Resonance.JOY
        Mood.FRUSTRATED -> Resonance.LOGIC
        Mood.NEUTRAL -> Resonance.entries.random()
    }