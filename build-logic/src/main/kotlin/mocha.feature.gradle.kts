...
// ============================================================================
// ROOM RUNTIME & TEST ENGINE INJECTION
// ============================================================================
    sourceSets {
...
// ============================================================================
// KSP DEFERRAL (DYNAMIC TEST SCOPE)
// ============================================================================
dependencies {
    val roomCompiler = getLibrary("room-compiler")

    // Safely waits for KSP to generate its internal configurations, then injects
    // the Room compiler ONLY into test variants. Protects commonMain from generation overhead.
