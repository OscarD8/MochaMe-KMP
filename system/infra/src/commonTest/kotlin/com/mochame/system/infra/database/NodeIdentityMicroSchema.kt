 ...
 */
@ConstructedBy(NodeIdentityDatabaseConstructor::class)
@Database(
    entities = [NodeIdentityEntity::class],
    version = 1,
    exportSchema = false
)
abstract class NodeIdentityMicroSchema : RoomDatabase() {
...
expect object NodeIdentityDatabaseConstructor : RoomDatabaseConstructor<NodeIdentityMicroSchema> {
    override fun initialize(): NodeIdentityMicroSchema
}