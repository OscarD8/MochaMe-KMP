...
// SUT ENVIRONMENT
// -----------------------------------------------------------
inline fun runJanitorTest(crossinline block: suspend JanitorTestEnvironment.(TestScope) -> Unit) =
    runPersistenceEnvironment<SyncTestDatabase, JanitorTestEnvironment>(
...
class SyncJanitorTest : MochaPlatformTest() {
    ...
    // -----------------------------------------------------------
    @Test
    fun yay_or_nay() = runJanitorTest { scope ->
